...
public class ConfigurationHandler
{
	...
	private static void loadConfiguration()
	{
		...
		mobconfig.enableStaffFragmentItem = configuration.getBoolean("enableStaffFragmentItem", "Mobs.Wither Skeleton", true, "Enable the staff fragment item required for the mob spawning staff recipe. If disabled, the staff crafting recipe will be disabled.");
		...
		mobconfig.staffSpawnedMobDropsFragmentFortune = configuration.getInt("staffSpawnedMobDropsFragmentFortune", "Mobs.Wither Skeleton", 0, 0, 3, "The fortune level required on a tool to get a better chance of getting the mob fragment.");
