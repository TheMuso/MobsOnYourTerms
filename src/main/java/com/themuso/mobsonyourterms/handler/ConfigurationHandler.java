...
public class ConfigurationHandler
{
	...
	private static void loadConfiguration()
	{
		...
		mobconfig.spawnRangeFromPlayerMaxHard = configuration.getInt("spawnRangeFromPlayerMaxHard", "Mobs.Skeleton", 6, 1, 6, "The maximum distance that a mob can be spawned from the player on hard difficulty.");
		...
		mobconfig.spawnRangeFromPlayerMinNormal = configuration.getInt("spawnRangeFromPlayerMinNormal", "Mobs.Witch", 1, 1, 7, "The minimum distance that a mob can be spawned from the player on normal difficulty.");
		...
		mobconfig.spawnRangeFromPlayerMinNormal = configuration.getInt("spawnRangeFromPlayerMinNormal", "Mobs.Ghast", 1, 1, 7, "The minimum distance that a mob can be spawned from the player on normal difficulty.");
		...
		mobconfig.spawnRangeFromPlayerMinEasy = configuration.getInt("spawnRangeFromPlayerMinEasy", "Mobs.Wither Skeleton", 1, 1, 10, "The minimum distance that a mob can be spawned from the player on easy difficulty.");
