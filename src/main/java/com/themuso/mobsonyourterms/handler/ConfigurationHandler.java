...
public class ConfigurationHandler
{
	...
	private static MobSettings populateConfig(String mobName, MobSettings mobSet)
	{
		...
		mobConfig.staffCreationPrimaryItemDamage = configuration.getInt(addToPropOrder(mobSettingsPropOrder, "staffCreationPrimaryItemDamage"), "Mobs." + mobName, mobSet.staffCreationPrimaryItemDamage, 0, 100, "The primary item damage needed for item subtypes such as lapis, ink sacs, etc.");
		...
		mobConfig.staffCreationSecondaryItemDamage = configuration.getInt(addToPropOrder(mobSettingsPropOrder, "staffCreationSecondaryItemDamage"), "Mobs." + mobName, mobSet.staffCreationSecondaryItemDamage, 0, 100, "The secondary item damage needed for item subtypes such as lapis, ink sacs, etc.");
