...
public class ConfigurationHandler
{
	...
	private static void loadConfiguration()
	{
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Creeper", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Creeper", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Creeper", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Creeper", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Creeper", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		...
		mobconfig.staffCreationPrimaryItemUses = configuration.getInt("staffCreationPrimaryItemUses", "Mobs.Spider", 0, 0, 100, "The number of times the staff can be used when it is created with the primary item. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Spider", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Spider", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Spider", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Spider", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		...
		mobconfig.staffCreationPrimaryItemUses = configuration.getInt("staffCreationPrimaryItemUses", "Mobs.Slime", 0, 0, 100, "The number of times the staff can be used when it is created with the primary item. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Slime", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Slime", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Slime", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Slime", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Slime", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Slime", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Silverfish", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Silverfish", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Silverfish", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Silverfish", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Silverfish", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Silverfish", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.staffCreationPrimaryItemUses = configuration.getInt("staffCreationPrimaryItemUses", "Mobs.Skeleton", 0, 0, 100, "The number of times the staff can be used when it is created with the primary item. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Skeleton", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Skeleton", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Skeleton", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Skeleton", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Skeleton", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Skeleton", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Witch", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Witch", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Witch", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Witch", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Witch", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Witch", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.PigZombie", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.PigZombie", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.PigZombie", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.PigZombie", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.PigZombie", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.PigZombie", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.staffCreationPrimaryItemUses = configuration.getInt("staffCreationPrimaryItemUses", "Mobs.Ghast", 0, 0, 100, "The number of times the staff can be used when it is created with the primary item. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Ghast", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Ghast", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Ghast", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Ghast", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Ghast", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Ghast", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.staffCreationPrimaryItemUses = configuration.getInt("staffCreationPrimaryItemUses", "Mobs.LavaSlime", 0, 0, 100, "The number of times the staff can be used when it is created with the primary item. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.LavaSlime", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.LavaSlime", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.LavaSlime", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.LavaSlime", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.LavaSlime", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.LavaSlime", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Wither Skeleton", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Wither Skeleton", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Wither Skeleton", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Wither Skeleton", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Wither Skeleton", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Wither Skeleton", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
		...
		mobconfig.staffCreationPrimaryItemUses = configuration.getInt("staffCreationPrimaryItemUses", "Mobs.Enderman", 0, 0, 100, "The number of times the staff can be used when it is created with the primary item. A value of 0 gives unlimited uses.");
		...
		mobconfig.minDroppedStaffFragmentsEasy = configuration.getInt("minDroppedStaffFragmentsEasy", "Mobs.Enderman", 2, 1, 10, "The minimum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsEasy = configuration.getInt("maxDroppedStaffFragmentsEasy", "Mobs.Enderman", 4, 1, 10, "The maximum number of staff fragments the mob will drop when killed on easy difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.minDroppedStaffFragmentsNormal = configuration.getInt("minDroppedStaffFragmentsNormal", "Mobs.Enderman", 1, 1, 5, "The minimum number of staff fragments the mob will drop when killed on normal difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.maxDroppedStaffFragmentsNormal = configuration.getInt("maxDroppedStaffFragmentsNormal", "Mobs.Enderman", 3, 1, 5, "The maximum number of staff fragments the mob will drop when killed on normal difficulty. A value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		mobconfig.minDroppedStaffFragmentsHard = configuration.getInt("minDroppedStaffFragmentsHard", "Mobs.Enderman", 1, 1, 3, "The minimum number of staff fragments the mob will drop when killed on hard difficulty. A random value will be chosen between the minimum and maximum dropped staff fragments settings, and will then be multiplied by the fortune level. If there is no fortune on the weapon used to kill the mob, a fortune level of 1 is used.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Enderman", 1, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Enderman", 5, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		mobconfig.staffFragmentAnvilUses = configuration.getInt("staffFragmentAnvilUses", "Mobs.Enderman", 0, 0, 100, "The number of times the staff can be used when it is created with staff fragments. A value of 0 gives unlimited uses.");
