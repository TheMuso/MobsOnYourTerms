...
public class ConfigurationHandler
{
	...
	private static void loadConfiguration()
	{
		...
		// WitherSkeleton
		mobconfig = new MobSettings();
		mobconfig.spawnXPLevelEasy = configuration.getInt("spawnXPLevelEasy", "Mobs.WitherSkeleton", 5, 1, 100, "The required amount of levels to be able to spawn this mob on easy difficulty.");
		mobconfig.spawnXPLevelNormal = configuration.getInt("spawnXPLevelNormal", "Mobs.WitherSkeleton", 7, 1, 100, "The required amount of levels to be able to spawn this mob on normal difficulty.");
		mobconfig.spawnXPLevelHard = configuration.getInt("spawnXPLevelHard", "Mobs.WitherSkeleton", 9, 1, 100, "The required amount of levels to be able to spawn this mob on hard difficulty.");
		...
		mobconfig.staffCooldownEasy = configuration.getInt("staffCooldownEasy", "Mobs.WitherSkeleton", 5, 0, 20, "The amount of time in seconds you have to wait before you can spawn more mobs with the staff on easy difficulty.");
		mobconfig.staffCooldownNormal = configuration.getInt("staffCooldownNormal", "Mobs.WitherSkeleton", 5, 0, 20, "The amount of time in seconds you have to wait before you can spawn more mobs with the staff on normal difficulty.");
		mobconfig.staffCooldownHard = configuration.getInt("staffCooldownHard", "Mobs.WitherSkeleton", 5, 0, 20, "The amount of time in seconds you have to wait before you can spawn more mobs with the staff on hard difficulty.");
