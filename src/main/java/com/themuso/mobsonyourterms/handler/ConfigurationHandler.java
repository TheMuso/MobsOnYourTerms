...
public class ConfigurationHandler
{
	...
	private static void loadConfiguration()
	{
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.PigZombie", 13, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.PigZombie", 15, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Ghast", 10, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Ghast", 15, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.LavaSlime", 17, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.LavaSlime", 15, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		...
		mobconfig.spawnRangeFromPlayerMinHard = configuration.getInt("spawnRangeFromPlayerMinHard", "Mobs.Wither Skeleton", 3, 1, 4, "The minimum distance that a mob can be spawned from the player on hard difficulty.");
		mobconfig.spawnRangeFromPlayerMaxHard = configuration.getInt("spawnRangeFromPlayerMaxHard", "Mobs.Wither Skeleton", 5, 1, 4, "The maximum distance that a mob can be spawned from the player on hard difficulty.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Wither Skeleton", 20, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Wither Skeleton", 20, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		...
		mobconfig.staffFragmentAnvilAmount = configuration.getInt("staffFragmentAnvilAmount", "Mobs.Enderman", 25, 1, 10, "The number of staff fragments needed to embew a spawning staff in an Anvil.");
		mobconfig.staffFragmentAnvilLevels = configuration.getInt("staffFragmentAnvilLevels", "Mobs.Enderman", 30, 1, 10, "The required number of experience levels to embue a spawning staff on an anvil with staff fragments.");
		...
		mobconfig.staffCooldownNormal = configuration.getInt("staffCooldownNormal", "Mobs.Enderman", 25, 0, 20, "The amount of time in seconds you have to wait before you can spawn more mobs with the staff on normal difficulty.");
		mobconfig.staffCooldownHard = configuration.getInt("staffCooldownHard", "Mobs.Enderman", 30, 0, 20, "The amount of time in seconds you have to wait before you can spawn more mobs with the staff on hard difficulty.");
